import { FaInstagram, FaLinkedinIn, FaMapMarkerAlt, FaEnvelope, FaPhone, FaGithub, } from 'react-icons/fa';
    ...
    <footer className="bg-gray-900 text-white py-10">
      <div className="container mx-auto flex flex-col md:flex-row justify-start items-start px-4 md:px-15 lg:px-100 space-y-8 md:space-y-0">
        ...
        <div className="w-full md:w-1/4 mb-8 md:mb-0">
          ...
          <div className="flex space-x-4 text-2lg">
            <a href="https://x.com/Ashwath26659973" className="text-white hover:text-gray-400 transition-colors duration-300">
              <img src='https://img.icons8.com/?size=100&id=fJp7hepMryiw&format=png&color=ffffff' alt="X Logo" className="w-8 h-8" />
            </a>
            <a href="https://www.instagram.com/__itz__.me.__ash__?igsh=c2N5MGFzZmRpOG5t" className="text-white hover:text-gray-400 transition-colors duration-300">
              <FaInstagram className="text-2xl" />
            </a>
            <a href="https://www.linkedin.com/in/ashwath-m-094aab265" className="text-white hover:text-gray-400 transition-colors duration-300">
              <FaLinkedinIn className="text-2xl" />
            </a>
            <a href="https://github.com/BadriGopikrishna" className="text-white hover:text-gray-400 transition-colors duration-300">
      ...
      <div className="border-t border-gray-800 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center px-6 md:px-12 lg:px-20">
        ...
        <div>
          ...
          >
            <p>Developed by Ashwath & Gopikrishna</p>
          </a>
        </div>
      </div>
    </footer>
