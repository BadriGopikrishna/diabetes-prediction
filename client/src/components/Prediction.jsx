...
const Prediction = () => {
  const [userInput, setUserInput] = useState({
    ...
    SkinThickness: "",
    DPF: "",
    DiabeticClass: "Unknown", // Added new field for dropdown
  });
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="mt-2">
                      ...
                      <select
                        name="DiabeticClass"
                        value={userInput.DiabeticClass}
                        onChange={handleChange}
                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-purple-500"
                      >
                        <option value="Unknown">Unknown</option>
                        <option value="Type 1">Stacking Classifier</option>
                      </select>
                    </div>
                  </div>
                </div>
          ...
          {!prediction && (
            <div className="bg-white p-6 rounded-lg shadow-lg mx-4 sm:mx-0 mt-4 sm:mt-0 w-full max-w-3xl">
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-700">
                ...
                <li><strong>Diabetic Class:</strong> Indicates the type of diabetes the patient has or suspects they might have.</li>
              </ul>
            </div>
          )}
          {prediction && (
